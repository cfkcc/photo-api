...
/*	public static void main(String[] args) throws Exception {
		...
		InputStream in = SpringTaskController.class.getResourceAsStream("conf/config.properties");
		prop.load(in);
	...
	public static void sendMail(String fromEmail,String toEmail,String emailName,String emailPassword,String title, String centent) throws Exception {
		send(fromEmail, toEmail, emailName, emailPassword, title, centent);

	}
	private static void send(String fromEmail, String toEmail, String emailName, String emailPassword, String title,
			String centent) throws MessagingException, AddressException {
